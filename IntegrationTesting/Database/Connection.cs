...
namespace IntegrationTests.Database
{
    ...
    public struct CommandDefinition
    {
        ...
        /// </summary>
        public int? CommandTimeout { get { return this.commandTimeout; } }
        /// <summary>
        /// The type of command that the command-text represents
        /// </summary>
        public CommandType? CommandType { get { return this.commandType; } }

        /// <summary>
        /// Should data be buffered before returning?
        /// </summary>
        public bool Buffered { get { return (this.flags & CommandFlags.Buffered) != 0; } }

        /// <summary>
        /// Should the plan for this query be cached?
        /// </summary>
        internal bool AddToCache { get { return (this.flags & CommandFlags.NoCache) == 0; } }

        /// <summary>
        /// Additional state flags against this command
        /// </summary>
        public CommandFlags Flags { get { return this.flags; } }

        /// <summary>
        /// Can async queries be pipelined?
        /// </summary>
        public bool Pipelined { get { return (this.flags & CommandFlags.Pipelined) != 0; } }
    ...
    static partial class SqlMapper
    {
        ...
        public class UdtTypeHandler : ITypeHandler
        {
            ...
            void ITypeHandler.SetValue(IDbDataParameter parameter, object value)
            {
                ...
                {
                    ((System.Data.SqlClient.SqlParameter)parameter).UdtTypeName = this.udtTypeName;
                }
            }
        }
...
#pragma warning restore 618
        ...
        public partial class Identity : IEquatable<Identity>
        {
            ...
            {
                return new Identity(this.sql, this.commandType, this.connectionString, primaryType, this.parametersType, null, gridIndex);
            }

            internal Identity ForGrid(Type primaryType, Type[] otherTypes, int gridIndex)
            {
                return new Identity(this.sql, this.commandType, this.connectionString, primaryType, this.parametersType, otherTypes, gridIndex);
            }
            /// <summary>
            ...
            {
                return new Identity(this.sql, this.commandType, this.connectionString, this.type, type, null, -1);
            }
            ...
            private Identity(string sql, CommandType? commandType, string connectionString, Type type, Type parametersType, Type[] otherTypes, int gridIndex)
            {
                ...
                unchecked
                {
                    ...
                    if (otherTypes != null)
                    {
                        ...
                        {
                            this.hashCode = this.hashCode * 23 + (t == null ? 0 : t.GetHashCode());
                        }
                    }
...
this IDbConnection cnn, string sql, Func<TFirst, TSecond, TThird, TFourth, TReturn> map, object param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null
        ...
        private sealed partial class DapperTable
        {
            ...
            internal string[] FieldNames { get { return this.fieldNames; } }
            ...
            {
                int result;
                return (name != null && this.fieldNameLookup.TryGetValue(name, out result)) ? result : -1;
            }
            ...
            public int FieldCount { get { return this.fieldNames.Length; } }
        }
            ...
            , IDictionary<string, object>
        {
            ...
            {
                var index = this.table.IndexOfName(name);
                if (index < 0)
                { // doesn't exist
                    value = null;
                    return false;
            ...
            {
                object value;
                return this.TryGetValue(item.Key, out value) && Equals(value, item.Value);
            }
            ...
            {
                get { object val; this.TryGetValue(key, out val); return val; }
        ...
        internal struct LiteralToken
        {
            ...
            /// </summary>
            public string Member { get { return this.member; } }
...
#pragma warning restore 618
        ...
        public partial class GridReader : IDisposable
        {
            ...
            private IEnumerable<T> ReadImpl<T>(Type type, bool buffered)
            {
                ...
                if (this.consumed) throw new InvalidOperationException("Query results must be consumed in the correct order, and each result can only be consumed once");
                ...
                this.consumed = true;
                var result = this.ReadDeferred<T>(this.gridIndex, deserializer.Func, typedIdentity);
            ...
            private IEnumerable<TReturn> MultiReadInternal<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(Delegate func, string splitOn)
            {
                ...
                try
                {
                    foreach (var r in SqlMapper.MultiMapImpl<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(null, default(CommandDefinition), func, splitOn, this.reader, identity, false))
                    {
                        yield return r;
                    }
                }
            ...
            private void NextResult()
            {
                ...
                else
                {
                    ...
                    this.reader.Dispose();
                    this.reader = null;
                    if (this.callbacks != null) this.callbacks.OnCompleted();
                    this.Dispose();
                }
            }
            /// <summary>
            ...
            public void Dispose()
            {
                if (this.reader != null)
                {
                    if (!this.reader.IsClosed && this.command != null) this.command.Cancel();
                    this.reader.Dispose();
                    this.reader = null;
                }
 ...
 = null
    ...
    partial class DynamicParameters : SqlMapper.IDynamicParameters, SqlMapper.IParameterLookup, SqlMapper.IParameterCallbacks
    {
        ...
        object SqlMapper.IParameterLookup.this[string member]
        {
            ...
            {
                ParamInfo param;
                return this.parameters.TryGetValue(member, out param) ? param.Value : null;
            }
        }
...
#pragma warning restore 612, 618
        ...
        public IEnumerable<string> ParameterNames
        {
            get
            {
                return this.parameters.Select(p => p.Key);
            }
        }
        ...
        {
            var val = this.parameters[Clean(name)].AttachedParam.Value;
            if (val == DBNull.Value)
            {
                if (default(T) != null)
                {
    ...
    sealed partial class DbString : SqlMapper.ICustomQueryParameter
    {
        ...
        public void AddParameter(IDbCommand command, string name)
        {
            ...
            var param = command.CreateParameter();
            param.ParameterName = name;
            param.Value = (object)this.Value ?? DBNull.Value;
    ...
    sealed partial class DefaultTypeMap : SqlMapper.ITypeMap
    {
        ...
        {
            var property = this._properties.FirstOrDefault(p => string.Equals(p.Name, columnName, StringComparison.Ordinal))
               ?? this._properties.FirstOrDefault(p => string.Equals(p.Name, columnName, StringComparison.OrdinalIgnoreCase));

            if (property == null && MatchNamesWithUnderscores)
            {
                property = this._properties.FirstOrDefault(p => string.Equals(p.Name, columnName.Replace("_", ""), StringComparison.Ordinal))
                    ?? this._properties.FirstOrDefault(p => string.Equals(p.Name, columnName.Replace("_", ""), StringComparison.OrdinalIgnoreCase));
            }

            if (property != null)
                return new SimpleMemberMap(columnName, property);

            var field = this._fields.FirstOrDefault(p => string.Equals(p.Name, columnName, StringComparison.Ordinal))
               ?? this._fields.FirstOrDefault(p => string.Equals(p.Name, columnName, StringComparison.OrdinalIgnoreCase));

            if (field == null && MatchNamesWithUnderscores)
            {
                field = this._fields.FirstOrDefault(p => string.Equals(p.Name, columnName.Replace("_", ""), StringComparison.Ordinal))
                    ?? this._fields.FirstOrDefault(p => string.Equals(p.Name, columnName.Replace("_", ""), StringComparison.OrdinalIgnoreCase));
            }
    ...
    internal class WrappedReader : IDataReader, IWrappedDataReader
    {
        ...
        {
            get { return this.reader == null ? true : this.reader.IsClosed; }
        }
