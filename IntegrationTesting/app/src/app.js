...
export class App {
  ...
  configureRouter(config, router){
    ...
    config.map([
      ...
      { route: 'tests-admin',  name: 'tests-admin', moduleId: 'tests/tests-admin', nav: true, title:'Admin', showContracts: (show) => {this.showContracts = show} }
    ]);

    this.router = router;
      this.router.createNavigationInstruction()
          .then(x => {
